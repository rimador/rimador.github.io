...
const header = /*html*/`
<a href="https://rimador.cat"><img class="rimador" id="rimadorImg" src="./assets/Rimador-1.webp" alt="Logo del Rimador en català"></a>
<button type="button" id="themeToggleBtn" class="peixet-btn" onclick="toggleTheme()" aria-label="Canvia entre mode festiu i mode sobri" title="Canvia d'estil"><img class="peixet" id="peixetImg" src="./assets/peixet.webp" alt="Peixet decoratiu"></button>
`
...
<br>Novetat! (23 d'abril) Nou domini! Ara ens trobes a <a id="enllaçbrillant" href="https://rimador.cat" target="_blank">rimador.cat</a>. Revisa tots els canvis <a id="enllaç" href="historial_canvis.html" target="_blank">aquí</a>.</p>
`
...
<form action="https://formspree.io/f/xeoazgnl" method="POST">
    ...
    <img class="gifok" src="./assets/ok1.webp" alt="Ok1">
    <img class="gifok" src="./assets/ok2.webp" alt="Ok2">
