...
} from './dades.js?v=1f851b1';
import {
    clauAleatoria, paraulaDelDia, manualDelDia, triarParaula,
    marge, rondesPersonalitzades,
} from './objectius.js?v=1f851b1';
import * as personalitzat from './personalitzat.js?v=1f851b1';
import { Partida, RESULTAT, formatarTemps } from './motor.js?v=1f851b1';
import * as ui from './ui.js?v=1f851b1';
import * as dialecte from './dialecte.js?v=1f851b1';
import {
