...
dades_json = {
    ...
    "setmana": {
        "top_5_paraules": formatar_top_per_json(obtenir_top_paraules(df_rimes_setmana, 5, 'paraula')),
        "top_5_rimes": formatar_top_per_json(obtenir_top_paraules(df_rimes_setmana, 5, 'rima')),
